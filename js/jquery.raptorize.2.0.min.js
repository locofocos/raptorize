...
'<img id="elRaptor" style="display: none" src="https://raw.githubusercontent.com/locofocos/raptorize/master/images/raptor.png" />';var raptorAudioMarkup='<audio id="elRaptorShriek" preload="auto"><source src="https://raw.githubusercontent.com/locofocos/raptorize/master/sounds/raptor-sound.mp3" /><source src="https://raw.githubusercontent.com/locofocos/raptorize/master/sounds/raptor-sound.ogg" /></audio>';var locked=false;$("body").append(raptorImageMarkup);if(audioSupported)$("body").append(raptorAudioMarkup);var raptor=$("#elRaptor").css({"position":"fixed","bottom":"-300px","right":"0","display":"none"});function init(){locked=true;$(window).scrollTop(9999999);var raptor=$("#elRaptor").css({"display":"block"});
...
"konami-code"){var kkeys=[],konami="38,38,40,40,37,39,37,39";$(window).bind("keydown.raptorz",function(e){kkeys.push(e.keyCode);if(kkeys.toString().indexOf(konami)>=0){init();$(window).unbind("keydown.raptorz")}})}})}})(jQuery);
